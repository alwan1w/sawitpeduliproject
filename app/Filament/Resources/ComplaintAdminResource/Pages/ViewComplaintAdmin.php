...
class ViewComplaintAdmin extends ViewRecord
{
    protected static string $resource = \App\Filament\Resources\ComplaintAdminResource::class;

    public $new_message = '';
    public $new_image;

    public static string $view = 'filament.resources.complaint_admins.chat';
